...
def generate_launch_description():
    ...
    localization_params = GroupAction(
        actions=[
            PushRosNamespace('husky'),
            PathJoinSubstitution(
                [FindPackageShare('husky_group'),
    ...
    config_husky_velocity_controller = GroupAction(
        actions=[
            PushRosNamespace('husky'),  
            PathJoinSubstitution(
                [FindPackageShare("husky_group"),
    ...
    #Launch the LIDAR
    launch_ouster_lidar = GroupAction(
        actions=[
            PushRosNamespace('husky'), 
            IncludeLaunchDescription(
