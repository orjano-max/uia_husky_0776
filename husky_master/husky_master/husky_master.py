...
class HuskyMasterNode(Node):
    ...
    def __init__(self, manipulator_model = "vx300"):
        ...
        self.goal_client = self.create_client(FollowPath, 'follow_path')
        
        self.action_sub  # prevent unused variable warning
    ...
    def publish_nav_goal(self, position_x, position_y, orientation_z):
